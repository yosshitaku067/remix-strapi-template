...
export class UploadFileService {
	 ...
	 * @throws ApiError
	 */
	public getUploadFiles1(id: string): CancelablePromise<UploadFile> {
		return this.httpRequest.request({
			method: "GET",
			url: "/upload/files/{id}",
			path: {
	 ...
	 * @throws ApiError
	 */
	public deleteUploadFiles(id: string): CancelablePromise<UploadFile> {
		return this.httpRequest.request({
			method: "DELETE",
			url: "/upload/files/{id}",
			path: {
